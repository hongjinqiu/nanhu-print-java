 ...
 *       &lt;attribute name="scaleToFitContentByPdf" type="{https://github.com/hongjinqiu/nanhu-print-java}trueOrFalse" />
...
public class Td {
    ...
    protected String id;
    @XmlAttribute(name = "scaleToFitContentByPdf")
    protected String scaleToFitContentByPdf;
     ...
     *     
     */
    public String getScaleToFitContentByPdf() {
        return scaleToFitContentByPdf;
    }

    /**
     * 设置scaleToFitContentByPdf属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setScaleToFitContentByPdf(String value) {
        this.scaleToFitContentByPdf = value;
    }
